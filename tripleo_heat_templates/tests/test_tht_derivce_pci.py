...
class TestDerivePciPassthru(testtools.TestCase):
    ...
    def test_get_passthrough_prodID_with_sysfsmap(self):
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, user_config_pfaddr)
        ...
        non_nicp, nicp = pci.generate_combined_configuration(user_config_pfaddr, system_configs_nonnicpart)
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, expected_output)
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, [{'product_id': '1572', 'vendor_id': '8086', 'trusted': 'true', 'address': '0000:18:00.4'}])
    ...
    def test_get_passthrough_config_by_product_vf_with_sysfsmap(self):
        ...
        self.checkequal(pci_passthrough, expected_output1)
        ...
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, expected_output2)
        ...
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, expected_output3)
        ...
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, user_config4)
        ...
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, expected_output5)
        ...
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, expected_output6)
        ...
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, expected_output7)
        ...
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, expected_output8)
        ...
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, expected_output9)
    ...
    def test_get_passthrough_config_by_address_sysfsmap(self):
        ...
        non_nicp, nicp = pci.generate_combined_configuration(user_config1, system_configs)
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, expected_list1)
        ...
        non_nicp, nicp = pci.generate_combined_configuration(user_config2, system_configs)
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, expected_list2)
        ...
        non_nicp, nicp = pci.generate_combined_configuration(user_config3, system_configs)
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, expected_list3)

        user_config4 = [{'address': '0000:18:0a.0', 'physical_network': 'sriov1', 'trusted': 'true'}]
        expected_list4 = []
        non_nicp, nicp = pci.generate_combined_configuration(user_config4, system_configs)
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, expected_list4)
        ...
        non_nicp, nicp = pci.generate_combined_configuration(user_config5, system_configs)
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, user_config5)

        user_config6 = [{'address': '0000:18:07.0', 'physical_network': 'sriov1', 'trusted': 'true'}]
        non_nicp, nicp = pci.generate_combined_configuration(user_config6, system_configs)
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, user_config6)
    ...
    def test_get_pciwhitelist_dict_with_sysfsmap(self):
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, dict_output1)
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, dict_output2)
        ...
        pci_passthro = (non_nicp + nicp)
        for item in pci_passthro:
            self.assertIn(item, dict_output3)
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, dict_output4)
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, dict_output5)
    ...
    def test_get_passthrough_devname_with_sysfsmap(self):
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, devname_output1)
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, devname_output2)
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, user_output3)
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, devname_output4)
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, devname_output5)
        ...
        pci_passthro = (non_nicp + nicp)
        self.checkequal(pci_passthro, devname_output6)
    ...
    def test_get_passthrough_config_nonmatch_usrcfgs(self):
        ...
        non_nicp, nicp = pci.generate_combined_configuration(user_config1, system_configs_nicpart)
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, user_config1)
        ...
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, user_config2)
        ...
        pci_passthrough = (non_nicp + nicp)
        self.checkequal(pci_passthrough, user_config3)
    ...
    def test_generate_combined_configuration_pass1(self):
        ...
        self.checkequal(result2, expected2)
    ...
    def test_get_allocated_pci_addresses_pass1(self):
        ...
        self.checkequal(result, expected)
    ...
    def test_get_pci_regex_pattern_pass2(self):
        ...
        for config in config_regex:
            ...
            self.checkequal(result, config_expected[config])
    ...
    def test_get_passthrough_config_pass1(self):
        ...
        self.checkequal(pci_passthro, expected_pci_passthro)
    ...
    def test_get_pci_passthrough_whitelist_pass1(self):
        ...
        self.checkequal(pci_whitelist_list, expected_pci_whitelist_list)
    ...
    def test_get_passthrough_config_pciformat_basic1(self):
        ...
        self.checkequal(pci_passthro, expected_1)
    ...
    def test_get_passthrough_config_by_address_pciaddr_single(self):
        ...
        self.checkequal(pci_passthro, [{'address': '0000:18:0a.2', 'physical_network': 'sriov1', 'trusted': 'true'}])
    ...
    def test_get_passthrough_config_by_pciaddr_wildcard_1(self):
        ...
        pci_passthro, stats = pci.get_passthrough_config_for_all_pf(user_config1, system_configs, allocated_pci)
        self.checkequal(pci_passthro, expected_list1)
        pci_passthro, stats = pci.get_passthrough_config_for_all_pf(user_config2, system_configs, allocated_pci)
        self.checkequal(pci_passthro, expected_list1)
    ...
    def test_get_passthrough_config_by_product_vf(self):
        ...
        self.checkequal(pci_passthro, expected_list)
